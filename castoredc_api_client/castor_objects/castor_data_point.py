...
class CastorDataPoint:
    ...
    def __init__(self, field_id: str, value: Union[str, int], study: "CastorStudy") -> None:
        """Creates a CastorField."""
        self.field_id = field_id
        self.value = value
        self.instance_of = self.find_field(study)
        if self.instance_of is None:
            raise CastorException("The field that this is an instance of does not exist in the study!")
    ...
    def __eq__(self, other: Any) -> Union[bool, type(NotImplemented)]:
        if not isinstance(other, CastorDataPoint):
            ...
            return (self.field_id == other.field_id) and (self.form_instance == other.form_instance)
