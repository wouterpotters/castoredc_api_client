...
class TestDataInterpretation:
    ...
    def integration_study_optiongroups(self, integration_study, client):
        integration_study.map_data(client)
        integration_study.load_optiongroups(client)
        return integration_study

    def test_data_interpret_number(self, integration_study_optiongroups):
        # Get data point with type radio
        dp = integration_study_optiongroups.get_single_data_point("110014", "1046822E-8C8B-4D8B-B29C-183CAC8B28AF",
                                                                  "his_smoke_dose")
        # Interpret answer
        dp.interpret()
    ...
    def test_data_interpret_checkbox_multiple(self, integration_study_optiongroups):
        ...
        assert "(Cardio)myopathy" in dp.value
        assert "Diabetes Mellitus" in dp.value
    ...
    def test_data_interpret_date(self, integration_study_optiongroups):
        ...
        dp.interpret()
        # Test if answer is correct
        assert dp.value == datetime(2020, 5, 12)
    ...
    def test_data_interpret_time(self, integration_study_optiongroups):
        ...
        dp = integration_study_optiongroups.get_single_data_point("110014", "A6CDB606-D094-4969-A984-7CA6E8B45883",
                                                                  "onset_stroke")
        # Interpret answer
        dp.interpret()
        # Test if answer is correct
        assert dp.value == datetime(2020, 5, 11, 7, 30)
    ...
    def test_data_interpret_slider(self, integration_study_optiongroups):
        ...
        dp = integration_study_optiongroups.get_single_data_point("110014", "418B08AA-AED0-4BBC-895F-CD4358900E11",
                                                                  "VAS")
        # Interpret answer
        dp.interpret()
        # Test if answer is correct
    ...
    def test_data_interpret_text_multi(self, integration_study_optiongroups):
        ...
        dp = integration_study_optiongroups.get_single_data_point("110014", "67273722-1A79-46BC-9E31-B793EACEAD37",
                                                                  "AE_type")
        # Interpret answer
        dp.interpret()
        # Test if answer is correct
        assert dp.value == "Ja, nou er ging ook gewoon van alles mis en toen deed de API het opeens."
    ...
    def test_data_interpret_file(self, integration_study_optiongroups):
        ...
        dp = integration_study_optiongroups.get_single_data_point("110014", "C2318B69-A4FB-480D-960D-BC5B4E1790F6",
                                                                  "comorbidities")
        # Interpret answer
        dp.interpret()
        # Test if answer is correct
    ...
    def test_data_interpret_number_and_date(self, integration_study_optiongroups):
        ...
        assert datetime(2021, 1, 14) in dp.value

    def test_data_interpret_missing(self, integration_study_optiongroups):
        # Get data point with missing data
        dp = integration_study_optiongroups.get_single_data_point("110014", "B153A407-8D0A-4174-B632-B89AADE3646B",
                                                                  "fu_sbp")
        # Interpret answer
        dp.interpret()
        # Test if answer is correct
        assert dp.value == "Missing (asked but unknown)"
